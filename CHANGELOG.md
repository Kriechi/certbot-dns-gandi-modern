...
* rebase modernization code changes to upstream v1.6.1
* bump certbot dependency to allow latest certbot v5 releases

## v1.6.1

* skipped based on [upstream version bump](https://github.com/obynio/certbot-plugin-gandi/releases/tag/1.6.1)
